...
function DroppableColumn({
    ...
    onCreateTask: (formData: FormData, columnId: string) => Promise<void>;
}) {
    ...
    return (
        <div
            ...
            className={`w-full lg:flex-shrink-0 lg:w-80 ${
                isOver ? "bg-orange-50 rounded-lg" : ""
            }`}
        >
            <div
                className={`bg-orange-50 rounded-lg shadow-sm border ${
                ...
                <div className="p-2">
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button
                                variant="ghost"
                                className="w-full mt-3 text-gray-600 hover:text-orange-50"
                            >
                                <Plus/>
                                Add Task
                            </Button>
...
export default function BoardPage() {
    ...
    async function handleCreateTaskFromColumn(formData: FormData, columnId: string) {
        const taskData = {
