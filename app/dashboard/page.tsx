            ...
            <main className="container mx-auto px-4 py-6 sm:py-8">
                <div className="mb-6 sm:mb-8">
                    ...
                    <p className="text-gray-700">
                        Here is an where you left off from your last session.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <Card
                        className={"bg-orange-50 shadow-xl"}>
                ...
                <div className="mb-6 sm:mb-8">
                    <div
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">Manage your projects and tasks</p>
                            {isFreeUser && (
                          ...
                          Updated{" "}
                            ...
                            <Card
                                ...
                                <CardContent
                                    ...
                                    <Plus
                                        className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400 group-hover:text-blue-600 mb-2"/>
            ...
            <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div
                            className="flex flex-col sm:flex-row justify-between pt-4 space-y-2 sm:space-y-0 sm:space-x-2">
