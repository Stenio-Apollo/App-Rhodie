...
export default function HomePage() {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Features Section */}
            <div className={"border bg-gradient-to-b from-slate-900 via-black to-slate-900"}>
                <section
                    className="bg-gradient-to-b from-slate-900 via-black to-slate-900 container mx-auto px-4 py-20">
