...
import type {SubscriptionVerificationPayload} from "../lib/subscription-backend";
...
export function useStoreBilling(session: Session | null) {
    ...
    const activeSubscription = useMemo<ActiveSubscriptionSnapshot | null>(() => {
    ...
    }, [billingConfigured, billingModule, plans, products, refreshStoreState, storeConnected]);
